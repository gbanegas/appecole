...
\begin{itemize} \item The research fills a significant gap, 
as LIX does not yet have expertise in hardware security. 
\item Validation is crucial to ensure that the developed 
countermeasures are both practical and effective. 
\item The project will be strengthened by leveraging my 
industrial experience and collaborations. 
\item A PhD student will be hired to work on the 
side-channel analysis and cryptographic hardware security 
framework. 
\end{itemize}
...
EPP. The program aims to equip students with advanced expertise in 
...
project will be carried out within the new research team at 
Bruyères-le-Châtel (CEA) and Gréneôble (IRISA), where early 
support will help build momentum for further developments, 
...
physical threats to cryptography. There is a strong demand in the 
...
fostering collaborations with industry leaders, such as CryptoExperts 
and professionals at NXP, we aim to develop expertise that translates 
