...
While schemes like Kyber and Dilithium (two post-quantum schemes) 
have reached advanced stages, post-quantum cryptography remains an 
active research area with \emph{critical challenges}. Following 
...
I did take into consideration and added at calendar the period for preparing and 
submiting the grant to ERC.
...
PicoScope 3000E & Oscilloscope & 1 & €$4\,655$ & \href{https://www.picotech.com/oscilloscope/picoscope-3000e-series-500-mhz-5gs-digital-usb-oscilloscope?model=3418E}{PicoTech} \\ \midrule
...
\begin{table}[H]
    ...
    \begin{tabular}{|ll|l|}
        ...
        \multirow{3}{*}{Personnel} 
            & 1 PhD & €$157$K\tnote{a}\\
            & 2 x 6-month M2 interns & €$8\,352$\tnote{b}\\
        \midrule
    ...
    \item[b] According to the \'Ecole: For trainees, the minimum remuneration is $4.35$ euros per hour, with no additional charge.
    \end{tablenotes}
    \end{threeparttable}
    }
    \label{tab:budget}
...
Current position: INRIA ISFP \& Chargé d'Enseignement in Computer Science, École polytechnique ~\\
